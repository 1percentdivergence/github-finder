        ...
        <div className="w-full py-5 rounded-lg shadow-md bg-base-100 stats">
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaUsers className='text-3xl md_text-5xl' />
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaUserFriends className='text-3xl md_text-5xl' />
            </div>
            <div className="stat-title pr-5">
               Following
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaCodepen className='text-3xl md_text-5xl' />
            </div>
            <div className="stat-title pr-5">
               Public Repos
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaStore className='text-3xl md_text-5xl' />
            </div>
            <div className="stat-title pr-5">
               Public Gists
            </div>
